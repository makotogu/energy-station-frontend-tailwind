...
import StatusTableForMobile from '../components/status-interface/StatusTableForMobile';
...
export default function Home() {
  ...
  return (
    <div className="grid grid-cols-12 gap-4 overflow-auto ">
      <div className="border col-start-2 col-span-10 sm:col-span-6 mt-2">
        <Tab.Group>
      ...
      <div className="border col-start-2 col-span-10 h-full">
        <StatusTableForMobile/>
      </div>
    </div>      
  )
}
