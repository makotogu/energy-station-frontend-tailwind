...
export default function LoginAnime() {
    ...
    return (
        <div className='opacity-75'>
            <svg className="absolute wave-one fill-blue-300 rotate-180 scale-y-75 translate-y-20 bottom-0 z-20" viewBox="0 0 1200 250">
            ...
            <svg className="absolute wave-two fill-blue-400 rotate-180 -left-30 scale-y-90 translate-y-20 bottom-10 z-10" viewBox="0 0 1200 250">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 108.306L50 114.323C100 120.34 200 132.374 300 168.476C400 204.578 500 264.749 600 246.698C700 228.647 800 132.374 900 108.306C1000 84.2382 1100 132.374 1150 156.442L1200 180.51V-8.5451e-06H1150C1100 -8.5451e-06 1000 -8.5451e-06 900 -8.5451e-06C800 -8.5451e-06 700 -8.5451e-06 600 -8.5451e-06C500 -8.5451e-06 400 -8.5451e-06 300 -8.5451e-06C200 -8.5451e-06 100 -8.5451e-06 50 -8.5451e-06H0V108.306Z" />
            </svg>   
            <svg className="absolute wave-three fill-blue-200 rotate-180 -left-30 scale-y-[0.6] -scale-x-100 translate-y-10 lg:translate-y-20 bottom-0 lg:-bottom-10 z-30 " viewBox="0 0 1200 250">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 108.306L50 114.323C100 120.34 200 132.374 300 168.476C400 204.578 500 264.749 600 246.698C700 228.647 800 132.374 900 108.306C1000 84.2382 1100 132.374 1150 156.442L1200 180.51V-8.5451e-06H1150C1100 -8.5451e-06 1000 -8.5451e-06 900 -8.5451e-06C800 -8.5451e-06 700 -8.5451e-06 600 -8.5451e-06C500 -8.5451e-06 400 -8.5451e-06 300 -8.5451e-06C200 -8.5451e-06 100 -8.5451e-06 50 -8.5451e-06H0V108.306Z" />
            </svg>
        </div>
    )
